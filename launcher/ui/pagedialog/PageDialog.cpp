    ...
    : QDialog(parent)
{
    ...
    QDialogButtonBox *buttons = new QDialogButtonBox(QDialogButtonBox::Help | QDialogButtonBox::Apply);
    buttons->button(QDialogButtonBox::Apply)->setDefault(true);
    buttons->setContentsMargins(6, 0, 6, 0);
    m_container->addButtons(buttons);

    connect(buttons->button(QDialogButtonBox::Apply), SIGNAL(clicked()), this, SLOT(close()));
